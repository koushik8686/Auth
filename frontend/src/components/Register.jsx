...
export default function Component() {
 ...
 const user = Cookies.get('user')
  ...
  const handleKYCSubmit = async (e) => {
    ...
    formData.append('company_name', kycDetails.company_name);
    formData.append('profile_pic', kycDetails.profile_pic);
        ...
        >
          <div className="rounded-2xl overflow-hidden shadow-2xl bg-white">
            <div className="bg-[#229799] p-8 text-white">
              <h2 className="text-4xl font-bold text-center mb-2">Welcome</h2>
              <p className="text-center text-[#F5F5F5]">Sign up to continue</p>
            </div>
            <div className="p-8 space-y-6">
              ...
              >
                <form onSubmit={handleKYCSubmit} className="space-y-6">
                  <div className="space-y-2">
                    <label htmlFor="company_name" className="block text-sm font-medium text-[#424242]">Company Name</label>
                    <input
                      id="company_name"
                      className="mt-1 block w-full px-4 py-3 bg-[#F5F5F5] border border-[#48CFCB] rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#229799] focus:border-transparent text-[#424242] placeholder-[#424242]"
